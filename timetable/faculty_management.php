...
<body>
    <div class="container">
        <h2>Faculty - Manage Timetable</h2>
        ...
        <table>
            ...
            <tr>
                ...
                <td class="action-links">
                    <a href="edit_timetable.php?id=<?= $entry['timetable_id'] ?>" style="background: #0288D1;">Edit</a>
                    <a href="delete_timetable.php?id=<?= $entry['timetable_id'] ?>" class="btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                </td>
            </tr>
            <?php } ?>
        </table>
