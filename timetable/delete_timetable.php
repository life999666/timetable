...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
    ...
    echo "<script>alert('Timetable updated successfully!'); window.location='faculty_management.php';</script>";
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete'])) {
    ...
    echo "<script>alert('Timetable entry deleted successfully!'); window.location='faculty_management.php';</script>";
}
?>
...
<body>
    <div class="container">
        ...
        <a href="faculty_management.php" class="back-link">Back</a>
    </div>
</body>
</html>
